    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        {rightIcon ? (
          ...
          <ChevronDownIcon className="text-muted-foreground pointer-events-none size- shrink-0 translate-y-0.5 transition-transform duration-200 group-data-[state=open]:rotate-180" />
        )}
      </AccordionPrimitive.Trigger>
